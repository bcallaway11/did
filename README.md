...
The following is a simplified example of the effect of states increasing their minimum wages on county-level teen employment rates which comes from [Callaway and Sant'Anna (2020)](https://authors.elsevier.com/a/1cFzc15Dji4pnC).
...
#>   2004 2004  -0.0105     0.0255       -0.0788      0.0578  
#>   2004 2005  -0.0704     0.0311       -0.1539      0.0130  
#>   2004 2006  -0.1373     0.0364       -0.2351     -0.0394 *
#>   2004 2007  -0.1008     0.0337       -0.1912     -0.0104 *
#>   2006 2004   0.0065     0.0242       -0.0583      0.0713  
#>   2006 2005  -0.0028     0.0186       -0.0526      0.0471  
#>   2006 2006  -0.0046     0.0184       -0.0539      0.0448  
#>   2006 2007  -0.0412     0.0205       -0.0961      0.0137  
#>   2007 2004   0.0305     0.0161       -0.0127      0.0737  
#>   2007 2005  -0.0027     0.0160       -0.0458      0.0403  
#>   2007 2006  -0.0311     0.0192       -0.0826      0.0204  
#>   2007 2007  -0.0261     0.0174       -0.0726      0.0205  
#> ---
...
#>  -0.0772        0.0203     -0.117     -0.0374 *
#> 
#> 
#> Dynamic Effects:
#>  Event time Estimate Std. Error [95% Simult.  Conf. Band]  
#>          -3   0.0305     0.0148       -0.0084      0.0694  
#>          -2  -0.0006     0.0123       -0.0330      0.0319  
#>          -1  -0.0245     0.0151       -0.0643      0.0154  
#>           0  -0.0199     0.0125       -0.0530      0.0131  
#>           1  -0.0510     0.0162       -0.0936     -0.0083 *
#>           2  -0.1373     0.0376       -0.2365     -0.0380 *
#>           3  -0.1008     0.0363       -0.1966     -0.0051 *
#> ---
#> Signif. codes: `*' confidence band does not cover 0
#> 
#> Control Group:  Never Treated,  Anticipation Periods:  0
...
#>   2004  -0.0797     0.0305       -0.1476     -0.0119 *
#>   2006  -0.0229     0.0169       -0.0605      0.0146  
#>   2007  -0.0261     0.0177       -0.0654      0.0133  
#> ---
#> Signif. codes: `*' confidence band does not cover 0
#> 
#> Control Group:  Never Treated,  Anticipation Periods:  0
