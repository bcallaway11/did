...
Finally, let's compute some standard errors using the nonparametric bootstrap (which is different from the multiplier bootstrap that we use in the *did* package); we'll just focus on the dynamic effects estimator
