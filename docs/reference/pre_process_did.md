...
Function to process arguments passed to the main methods in the `did`
package as well as conducting some tests to make sure data is in proper
format / try to throw helpful error messages.
